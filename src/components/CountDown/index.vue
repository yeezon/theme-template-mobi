<template>
    <div class="sk-count_down">
        <span v-if="timeType === 'entirety'" class="entirety">{{ time }}</span>
        ...
        <div  v-if="timeType === 'tuanjoin'"  class="entirety">
          {{ timeTuan }}
        </div>
...
export default {
  ...
  methods: {
    ...
    //     for (let item of this.$refs.single.getElementsByClassName('s-bg')) {
    //       item.style.padding = `4px 6px 2px`
    //     }
    //      for (let item of this.$refs.single.getElementsByClassName('s-item')) {
